          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                itemCount: inAppPurchaseProvider.getRemoveAdProducts.length,
                itemBuilder: ((context, index) {
                  return GestureDetector(
                    onTap: () async {
                      inAppPurchaseProvider.setIsRestore(false);

                      await inAppPurchaseProvider.getIApEngine.inAppPurchase
                          .restorePurchases()
                          .whenComplete(() async {
                        await Future.delayed(const Duration(seconds: 1))
                            .then((value) async {
                          if (inAppPurchaseProvider.getRemoveAdSubExisting &&
